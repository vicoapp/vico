...
(amap setKey:"<down>" toMotion:"move_down_soft:" flags:ViMapLineMode)
(amap setKey:"<up>" toMotion:"move_up_soft:" flags:ViMapLineMode)
...
(imap setKey:"<c-r>" toAction:"input_register:" flags:ViMapNeedArgument)
...
(imap setKey:"<c-v>" toAction:"literal_next:" flags:ViMapNeedArgument)
...
(mmap setKey:"<c-j>" toMotion:"move_down:" flags:ViMapLineMode)
(mmap setKey:"<c-m>" toMotion:"move_down_bol:" flags:ViMapLineMode)
...
(mmap setKey:"F" toMotion:"move_back_to_char:" flags:ViMapNeedArgument)
(mmap setKey:"G" toMotion:"goto_line:" flags:ViMapLineMode parameter:YES scope:nil)
(mmap setKey:"H" toMotion:"move_high:" flags:ViMapLineMode)
(mmap setKey:"L" toMotion:"move_low:" flags:ViMapLineMode)
(mmap setKey:"M" toMotion:"move_middle:" flags:ViMapLineMode)
(mmap setKey:"N" toMotion:"repeat_find_backward:")
(mmap setKey:"T" toMotion:"move_back_til_char:" flags:ViMapNeedArgument)
(mmap setKey:"W" toMotion:"word_forward:")
(mmap setKey:"0" toMotion:"move_bol:")
(mmap setKey:"b" toMotion:"word_backward:")
(mmap setKey:"e" toMotion:"end_of_word:")
(mmap setKey:"f" toMotion:"move_to_char:" flags:ViMapNeedArgument)
...
(mmap setKey:"j" toMotion:"move_down:" flags:ViMapLineMode)
(mmap setKey:"k" toMotion:"move_up:" flags:ViMapLineMode)
(mmap setKey:"l" toMotion:"move_right:")
(mmap setKey:"n" toMotion:"repeat_find:")
(mmap setKey:"t" toMotion:"move_til_char:" flags:ViMapNeedArgument)
(mmap setKey:"w" toMotion:"word_forward:")
(mmap setKey:"$" toMotion:"move_eol:")
(mmap setKey:"_" toMotion:"move_down_bol2:" flags:ViMapLineMode)
(mmap setKey:"+" toMotion:"move_down_bol:" flags:ViMapLineMode)
(mmap setKey:"-" toMotion:"move_up_bol:" flags:ViMapLineMode)
...
(mmap setKey:"'" toMotion:"move_to_mark:" flags:(| ViMapNeedArgument ViMapLineMode))
(mmap setKey:"`" toMotion:"move_to_mark:" flags:ViMapNeedArgument)
(mmap setKey:"g'" toMotion:"move_to_mark:" flags:(| ViMapNeedArgument ViMapLineMode))
(mmap setKey:"g`" toMotion:"move_to_mark:" flags:ViMapNeedArgument)
...
(nmap setKey:"A" toEditAction:"append_eol:" flags:ViMapUpdatesAllCursors)
(nmap setKey:"C" toEditAction:"change_eol:")
(nmap setKey:"D" toEditAction:"delete_eol:")
(nmap setKey:"I" toEditAction:"insert_bol:" flags:ViMapUpdatesAllCursors)
(nmap setKey:"J" toEditAction:"join:")
(nmap setKey:"O" toEditAction:"open_line_above:" flags:ViMapUpdatesAllCursors)
(nmap setKey:"P" toEditAction:"put_before:")
(nmap setKey:"S" toEditAction:"subst_lines:" flags:ViMapLineMode)
(nmap setKey:"V" toAction:"visual_line:")
(nmap setKey:"X" toEditAction:"delete_backward:")
(nmap setKey:"Y" toAction:"yank:" flags:ViMapLineMode)
(nmap setKey:"a" toEditAction:"append:" flags:ViMapUpdatesAllCursors)
(nmap setKey:"c" toOperator:"change:")
(nmap setKey:"cc" toEditAction:"subst_lines:" flags:ViMapLineMode)
(nmap setKey:"d" toOperator:"delete:")
(nmap setKey:"i" toEditAction:"insert:")
(nmap setKey:"m" toAction:"set_mark:" flags:ViMapNeedArgument)
(nmap setKey:"o" toEditAction:"open_line_below:" flags:ViMapUpdatesAllCursors)

(nmap setKey:"p" toEditAction:"put_after:")
(nmap setKey:"q" toAction:"toggle_record_macro:" flags:(| ViMapNeedArgument ViMapNoArgumentOnToggle))
(nmap setKey:"r" toEditAction:"replace:" flags:ViMapNeedArgument)
(nmap setKey:"r<ctrl-v>" toEditAction:"replace_literal:" flags:ViMapNeedArgument)
...
(nmap setKey:"y" toAction:"yank:" flags:ViMapNeedMotion)
(nmap setKey:"=" toOperator:"indent:" flags:ViMapLineMode)
(nmap setKey:":" toAction:"ex_command:")
(nmap setKey:">" toOperator:"shift_right:" flags:ViMapLineMode)
(nmap setKey:"<" toOperator:"shift_left:" flags:ViMapLineMode)
(nmap setKey:"!" toOperator:"filter:" flags:ViMapLineMode)
(nmap setKey:"." toAction:"dot:")
(nmap setKey:"~" toEditAction:"toggle_case:")
(nmap setKey:"@" toAction:"execute_register:" flags:ViMapNeedArgument)
...
(nmap setKey:"gUgU" toEditAction:"uppercase:" flags:ViMapLineMode)
(nmap setKey:"gu" toOperator:"lowercase:")
(nmap setKey:"gugu" toEditAction:"lowercase:" flags:ViMapLineMode)
(nmap setKey:"g~" toOperator:"toggle_case_op:")
(nmap setKey:"g~g~" toEditAction:"toggle_case_op:" flags:ViMapLineMode)
(nmap setKey:"gt" toAction:"next_tab:")
(nmap setKey:"gT" toAction:"previous_tab:")
(nmap setKey:"gq" toOperator:"format:" flags:ViMapLineMode)
(nmap setKey:"gqgq" toEditAction:"format:" flags:ViMapLineMode)
;; z prefix
...
(vmap setKey:"q" toAction:"toggle_record_macro:" flags:(| ViMapNeedArgument ViMapNoArgumentOnToggle))
(vmap setKey:"p" toEditAction:"put_after:")
(vmap setKey:"r" toEditAction:"replace:" flags:ViMapNeedArgument)
...
(vmap setKey:"<" toEditAction:"shift_left:" flags:ViMapLineMode)
(vmap setKey:">" toEditAction:"shift_right:" flags:ViMapLineMode)
(vmap setKey:"!" toEditAction:"filter:" flags:ViMapLineMode)
(vmap setKey:"=" toEditAction:"indent:" flags:ViMapLineMode)
...
(xmap setKey:"<c-v>" toAction:"literal_next:" flags:ViMapNeedArgument)
(xmap setKey:"<c-r>" toAction:"input_register:" flags:ViMapNeedArgument)
