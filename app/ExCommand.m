...
struct ex_command ex_commands[] = {
	...
	{@"eval",	@"ex_eval",	EX_ADDR2,
		"",
		@"[line [,line]] eval",
		@"evaluate a buffer as a Nu script"},
	{@"export",	@"ex_export",	0,
		"s",
		@"export var=[value]",
	...
	{@"t",		@"ex_copy",	EX_ADDR2|EX_AUTOPRINT,
		...
		@"copy lines elsewhere in the file"},
	{@"tabedit",	@"ex_tabedit",	EX_NEWSCREEN,
		"f1o",
		@"tabe[dit] [+cmd] [file]",
		@"edit another file in another tab"},
	{@"tabnew",	@"ex_tabnew",	0,
		"f1o",
		@"tabnew [file]",
		@"edit a new file in another tab"},
	/* C_TAG */
