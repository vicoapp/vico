...
(mmap setKey:"}" toMotion:"paragraph_forward:" flags:ViMapLineMode parameter:nil scope:nil)
(mmap setKey:"{" toMotion:"paragraph_backward:" flags:ViMapLineMode parameter:nil scope:nil)
